...
import com.csc207.project.flights.*;
...
public class Driver {
    ...
    private static SearchItinsActivity searchItins = new SearchItinsActivity();
    ...
    public static String getItineraries(String date, String origin, String destination) {
        try {
            return searchItins.getItineraries(date, origin, destination);
